...
CONSTANTS = {
        ...
        "SYSTEM_MESSAGE": (
            ...
            "   - Once an item is fully configured (status: ITEM_COMPLETE), call `finalize_current_item`.\n"
            "   - This adds the item to the cart.\n"
            "   - Say the confirmation message: 'Okay, I've added [item] to your order. Anything else?'\n\n"
            ...
            "- NEVER call `finalize_current_item` until an item's configuration is complete.\n"
