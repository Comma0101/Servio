...
@app.get("/test-square-simple")
async def test_square_simple():
    try:
        import logging

        logging.basicConfig(level=logging.INFO)
        logger = logging.getLogger("test_square_simple")
        ...
        # Step 2: Create a simple order with a hardcoded item
        ...
        # Return with direct links to view in dashboard
        return {
            "status": "success",
            "order_id": order_id,
            ...
            "view_links": {
                ...
                "orders": "https://squareupsandbox.com/dashboard/orders",
                "direct_order": f"https://squareupsandbox.com/dashboard/orders/{order_id}",
                "transactions": "https://squareupsandbox.com/dashboard/sales/transactions",
            },
            "instructions": "1. Log in to your Square Sandbox account\n2. Click on 'Orders' in the left menu\n3. Look for the order with this ID\n4. If not visible, try adjusting the date filters to include future dates",
        }
