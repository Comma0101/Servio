...
print(f"Checking for OpenAI API Key...", flush=True)
if os.getenv("OPENAI_API_KEY"):
    print(f"OpenAI API Key loaded: {os.getenv('OPENAI_API_KEY')[:5]}...", flush=True)
else:
    print("WARNING: OpenAI API Key not found!", flush=True)
